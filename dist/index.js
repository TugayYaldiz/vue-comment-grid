!function(root, factory) {
    ...
    return function(modules) {
        ...
        __webpack_exports__.a = {
            ...
            methods: {
                checkAutoLogin: function() {
                    ...
                    if (token) {
                        ...
                        if (!(now >= expirationDate)) {
                            var userId = localStorage.getItem("commentUserId"), userName = localStorage.getItem("commentUserName"), data = [ token, userId, userName, remainingTime ];
                            this.signUser(data);
                        }
                    }
                },
                signUser: function(data) {
                    var _this = this;
                    this.idToken = data[0], this.userId = data[1], this.userName = data[2], this.logOutTimer = setTimeout(function() {
                        _this.clearAuth();
                    }, 1e3 * data[3]), this.isAdmin = data[4], this.auth = !0, this.showSignPanel = !1;
                },
                clearAuth: function() {
        ...
        __webpack_exports__.a = {
            ...
            methods: {
                ...
                resize: function(event, from) {
                    event.target.style.height = event.target.scrollHeight + "px", from ? "" == this.updateMessage && 32 != this.$refs.addUpdate.style.height && (this.$refs.addUpdate.style.height = "32px") : "" == this.replyMessage && 32 != this.$refs.addReply.style.height && (this.$refs.addReply.style.height = "32px");
                },
                ...
                update: function() {
                    var _this4 = this;
                    if (this.auth) if (this.requestLoading = !0, this.isAdmin) {
                        var _replyObj = {
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.patch(this.baseURL + "/" + this.depth + ".json?auth=" + this.idToken, _replyObj).then(function(res) {
                            _this4.clearAlert(), _this4.filteredComment = _this4.filterNewUpdate, _this4.updateMessage = "", 
                            _this4.beforeUpdate = !1;
                        }).catch(function(err) {
                        ...
                        console.log(this.depth), __WEBPACK_IMPORTED_MODULE_0_axios___default.a.patch(this.baseURL + "/" + this.depth + ".json?auth=" + this.idToken, replyObj).then(function(res) {
                            _this4.clearAlert(), _this4.filteredComment = _this4.filterNewUpdate, _this4.updateMessage = "", 
                            _this4.beforeUpdate = !1;
                        }).catch(function(err) {
                            _this4.setAlert("İnvalid comment or comment deleted!\n", "fail"), setTimeout(function() {
            ...
            watch: {
                ...
                deleted: function() {
                    var _this8 = this;
                    this.deletedProp = !0, console.log("selam çak");
                    var splt = this.depth.split("/"), changeDept1 = splt[0] + "/" + splt[1] + "/" + splt[2] + "/" + splt[splt.length - 1];
        ...
        var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Sign_vue__ = __webpack_require__(14), __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_05cdafea_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Sign_vue__ = __webpack_require__(44), normalizeComponent = __webpack_require__(3), __vue_styles__ = injectStyle, Component = normalizeComponent(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Sign_vue__.a, __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_05cdafea_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Sign_vue__.a, !1, __vue_styles__, "data-v-05cdafea", null);
            ...
            methods: {
                signUp: function(event) {
                    ...
                    setTimeout(function() {
                        ...
                        var data = [ res.data.idToken, res.data.localId, _this.filterNewUserName, res.data.expiresIn ];
                        _this.signUser(data), _this.setLocalStorageItems(res.data.idToken, res.data.localId, res.data.expiresIn, _this.filterNewUserName), 
                ...
                signIn: function(event) {
                    ...
                    event && event.preventDefault(), this.requestLoading = !0, INSTANCE.post("/verifyPassword?key=" + this.apiKey, {
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(_this2.baseURL + "/commentUsers/" + res.data.localId + ".json?auth=" + res.data.idToken).then(function(res) {
                            ...
                            _this2.signUser(data), _this2.setLocalStorageItems(_this2.idTokenD, _this2.userIdD, _this2.expiresInD, res.data.name), 
                ...
                setLocalStorageItems: function(token, userId, expDate, userName) {
        ...
        var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Comments_vue__ = __webpack_require__(6), __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5ab91dd8_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Comments_vue__ = __webpack_require__(46), normalizeComponent = __webpack_require__(3), __vue_styles__ = injectStyle, Component = normalizeComponent(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Comments_vue__.a, __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5ab91dd8_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Comments_vue__.a, !1, __vue_styles__, "data-v-5ab91dd8", null);
        __webpack_exports__.a = Component.exports;
    }, function(module, exports, __webpack_require__) {
        var content = __webpack_require__(18);
        "string" == typeof content && (content = [ [ module.i, content, "" ] ]), content.locals && (module.exports = content.locals);
        __webpack_require__(2)("723045f8", content, !0, {});
    }, function(module, exports, __webpack_require__) {
        ...
        exports.push([ module.i, ".loader[data-v-5ab91dd8]{display:grid;grid-template-columns:1fr;grid-auto-rows:minmax(150px,auto);padding:5px}#loader[data-v-5ab91dd8]{justify-self:center;align-self:center}.comments[data-v-5ab91dd8] .alert{grid-column:1/3;display:grid;grid-template-columns:1fr;grid-gap:5px;border-top-left-radius:40px;border-bottom-right-radius:40px;border-width:3px 0;border-style:solid;color:#fff;font-size:13px;padding-top:15px;padding-bottom:15px;padding-left:15px;white-space:pre-line;text-align:center}.comments[data-v-5ab91dd8] .alert.alert{border-color:rgba(0,0,0,.12)!important}.comments[data-v-5ab91dd8] .success{background-color:#4caf50!important}.comments[data-v-5ab91dd8] .pass{border-color:#4caf50!important}.comments[data-v-5ab91dd8] .info{background-color:#2196f3!important}.comments[data-v-5ab91dd8] .default{border-color:#2196f3!important}.comments[data-v-5ab91dd8] .alert.fail{background-color:#ff5252!important}.comments[data-v-5ab91dd8] .fail{border-color:#ff5252!important}.comments[data-v-5ab91dd8] ::-webkit-input-placeholder{color:#92b1b3!important;text-align:center}.comments[data-v-5ab91dd8] ::-moz-placeholder{color:#92b1b3!important;text-align:center}.comments[data-v-5ab91dd8] :-ms-input-placeholder{color:#92b1b3!important;text-align:center}.comments[data-v-5ab91dd8] :-moz-placeholder{color:#92b1b3!important;text-align:center}.comments[data-v-5ab91dd8]{font-family:Roboto,sans-serif;overflow:hidden;border-radius:4px;-webkit-tap-highlight-color:transparent;-webkit-touch-callout:none;-webkit-text-size-adjust:100%;-webkit-font-smoothing:antialiased}.comments[data-v-5ab91dd8] .comments{overflow-x:auto}.comments>.innerWrapper[data-v-5ab91dd8]{overflow-x:auto;padding:10px 2px}.comments[data-v-5ab91dd8] .noCommentWrapper{display:grid;padding-top:15px}.comments[data-v-5ab91dd8] .noCommentText{color:#2a5ebe;cursor:pointer;text-align:center;border:1px solid #2a5ebe;padding:8px 10px;font-weight:700;border-radius:18px;border-top-right-radius:0;border-bottom-left-radius:0;transition:all .1s linear;-moz-transition:linear .1s all;-webkit-transition:all .1s linear}.comments[data-v-5ab91dd8] .noCommentText:hover{color:#fff;background-color:#2a5ebe}.comments[data-v-5ab91dd8] .userName{grid-column:1/3;display:grid;grid-template-columns:1fr .001fr;font-size:14px;line-height:14px;font-weight:700;color:#06b1b7;word-break:break-word}.comments[data-v-5ab91dd8] .userName>.logOut{grid-column:2;white-space:nowrap;color:#92b1b3;cursor:pointer;margin-right:10px;transition:color .1s linear;-moz-transition:color linear .1s;-webkit-transition:color .1s linear}.comments[data-v-5ab91dd8] .userName>.logOut:hover{color:#06b1b7}.comments[data-v-5ab91dd8] .dot{color:#c2c6cc;font-size:13px;white-space:nowrap}.comments[data-v-5ab91dd8] .avatar{border-top-left-radius:22px;border-top-right-radius:22px}.comments[data-v-5ab91dd8] .avatar>svg{border-radius:50%;height:44px;width:44px;transition:.3s;-moz-transition:.3s;-webkit-transition:.3s}.comments[data-v-5ab91dd8] .addComment{display:grid;grid-template-columns:.001fr 1fr;grid-auto-rows:minmax(0,auto);grid-column-gap:10px;padding-top:2px}.comments[data-v-5ab91dd8] .commentBox{display:grid;grid-template-columns:minmax(200px,auto) .2fr;grid-auto-rows:minmax(0,-webkit-max-content);grid-auto-rows:minmax(0,max-content);grid-auto-rows:minmax(0,-moz-max-content);grid-row-gap:10px;overflow:auto}.comments[data-v-5ab91dd8] .commentBox>textarea{height:auto;color:#2a2e2e;justify-self:stretch;height:32px;padding:8px 22px 8px 10px;border-radius:18px;border:1px solid rgba(204,212,216,.8);overflow:hidden;resize:none}.comments[data-v-5ab91dd8] .commentBox>button,.comments[data-v-5ab91dd8] .commentBox>textarea{font-family:Roboto,sans-serif;box-sizing:border-box;font-size:13px;line-height:16px;outline:none;transition:all .1s linear;-moz-transition:linear .1s all;-webkit-transition:all .1s linear}.comments[data-v-5ab91dd8] .commentBox>button{background-color:#2a5ebe;align-self:end;color:#fff;max-height:32px;height:32px;padding:8px 10px;font-weight:700;border-radius:18px;border:none;cursor:pointer;z-index:100}.comments[data-v-5ab91dd8] .commentBox>button:hover{background-color:#254b91}.comments[data-v-5ab91dd8] .remainingLetter{justify-self:end;align-self:start;box-sizing:border-box;height:32px;display:grid;border-top-left-radius:18px;padding-left:3px;padding-right:22px;margin-top:-42px;margin-right:-22px;z-index:99}.comments[data-v-5ab91dd8] .remainingLetter>span{align-self:center;font-size:11px;line-height:11px;padding:3px;color:#eee}.comments[data-v-5ab91dd8] .updateLimit{display:grid;grid-template-columns:1fr}.comments[data-v-5ab91dd8] .limit{color:#06b1b7;font-weight:700;justify-self:center;font-size:14px;line-height:14px;box-sizing:border-box;border-radius:18px;padding:8px 10px;cursor:pointer;transition:all .1s linear;-moz-transition:linear .1s all;-webkit-transition:all .1s linear}.comments[data-v-5ab91dd8] .limit:hover{color:#fff;background-color:#2196f3}.comments[data-v-5ab91dd8] .fade-enter{opacity:0}.comments[data-v-5ab91dd8] .fade-enter-active,.comments[data-v-5ab91dd8] .fade-leave-active{transition:opacity .3s;-moz-transition:opacity .3s;-webkit-transition:opacity .3s}.comments[data-v-5ab91dd8] .fade-leave-active{opacity:0}@media screen and (max-width:480px){.comments[data-v-5ab91dd8] .avatar>svg{height:20px;width:20px}.comments[data-v-5ab91dd8] .nameWrapper>.time{overflow:hidden;width:38px;text-overflow:ellipsis}}@media (hover:none){.comments[data-v-5ab91dd8] ::-webkit-scrollbar{-webkit-appearance:none!important;width:5px!important;height:5px!important;background-color:rgba(204,212,216,.2)!important}.comments[data-v-5ab91dd8] ::-webkit-scrollbar-thumb{background:rgba(204,212,216,.7)!important}.comments[data-v-5ab91dd8] .commentBox{overflow:unset}}.comments[data-v-5ab91dd8] .requestLoading{display:inline-block;border:4px solid transparent;border-left-color:#fff;border-radius:50%;width:10px;height:10px;animation:requestLoading-spin-data-v-5ab91dd8 .5s linear infinite}@keyframes requestLoading-spin-data-v-5ab91dd8{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}", "" ]);
    }, function(module, exports) {
        ...
        var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Comment_vue__ = __webpack_require__(7), __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_03de2f2e_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Comment_vue__ = __webpack_require__(45), normalizeComponent = __webpack_require__(3), __vue_styles__ = injectStyle, Component = normalizeComponent(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Comment_vue__.a, __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_03de2f2e_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Comment_vue__.a, !1, __vue_styles__, "data-v-03de2f2e", null);
        __webpack_exports__.a = Component.exports;
    }, function(module, exports, __webpack_require__) {
        var content = __webpack_require__(22);
        "string" == typeof content && (content = [ [ module.i, content, "" ] ]), content.locals && (module.exports = content.locals);
        __webpack_require__(2)("27c7cc53", content, !0, {});
    }, function(module, exports, __webpack_require__) {
        exports = module.exports = __webpack_require__(1)(!1), exports.push([ module.i, ".comments[data-v-03de2f2e]{font-family:Roboto,sans-serif;overflow:hidden;border-radius:4px;-webkit-tap-highlight-color:transparent;-webkit-touch-callout:none;-webkit-text-size-adjust:100%;-webkit-font-smoothing:antialiased}.comments[data-v-03de2f2e] .wrapper{display:grid;grid-template-columns:.001fr 1fr;grid-auto-rows:minmax(0,auto);grid-column-gap:10px;padding-top:15px}.comments[data-v-03de2f2e] .commentWrapper{display:grid;grid-auto-rows:minmax(0,auto);grid-auto-columns:minmax(-webkit-min-content,-webkit-max-content);grid-auto-columns:minmax(min-content,max-content);grid-auto-columns:minmax(-moz-min-content,-moz-max-content);grid-gap:10px}.comments[data-v-03de2f2e] .hiddenMessage{color:#ffc107;word-break:break-word;font-size:13px}.comments[data-v-03de2f2e] .nameWrapper{display:grid;grid-template-columns:repeat(4,.001fr);grid-auto-columns:minmax(0,auto);grid-column-gap:5px;line-height:13px;white-space:nowrap;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.comments[data-v-03de2f2e] .nameWrapper>.name{color:#06b1b7;font-size:14px;line-height:14px;font-weight:700;white-space:nowrap}.comments[data-v-03de2f2e] .nameWrapper>.time{cursor:help;font-size:13px;color:#92b1b3;white-space:nowrap;text-decoration:none}.comments[data-v-03de2f2e] .nameWrapper>.expand{cursor:pointer;display:grid;width:22px;height:13px;border-radius:3px;color:#ccd4d8;box-shadow:inset 0 0 0 2px #ccd4d8;transition:color .1s linear;-moz-transition:color linear .1s;-webkit-transition:color .1s linear}.comments[data-v-03de2f2e] .nameWrapper>.expand:hover{color:#2196f3}.comments[data-v-03de2f2e] .nameWrapper>.expand>span{align-self:center;justify-self:center;font-size:20px}.comments[data-v-03de2f2e] .comment{white-space:pre-wrap;overflow-wrap:break-word;word-wrap:break-word;-ms-word-break:break-all;word-break:break-all;word-break:break-word;-ms-hyphens:auto;-moz-hyphens:auto;-webkit-hyphens:auto;hyphens:auto;background:#fff;color:#1d2129;font-size:13px;line-height:16px;font-kerning:normal;padding:8px 10px;border-radius:18px;border:1px solid rgba(204,212,216,.8);min-width:-webkit-min-content;min-width:min-content;min-width:-moz-min-content;max-width:-webkit-max-content;max-width:max-content;max-width:-moz-max-content}.comments[data-v-03de2f2e] .reply{display:grid;grid-template-columns:repeat(7,.001fr);grid-auto-columns:minmax(0,auto);grid-auto-rows:minmax(0,auto);grid-column-gap:5px;font-size:13px;white-space:nowrap;color:#92b1b3;margin-top:-8px;margin-left:10px;transition:color .1s linear;-moz-transition:color linear .1s;-webkit-transition:color .1s linear;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.comments[data-v-03de2f2e] .reply>div{cursor:pointer}.comments[data-v-03de2f2e] .reply>div:hover{color:#2196f3}.comments[data-v-03de2f2e] .reply>.delete{display:grid;box-sizing:border-box;height:-webkit-min-content;height:-moz-min-content;height:min-content}.comments[data-v-03de2f2e] .reply>.delete:hover,.comments[data-v-03de2f2e] .reply>.delete>.deleteText:hover{color:#ff5252}.comments[data-v-03de2f2e] .reply>.delete>.deletePrompt{display:grid;grid-template-columns:1fr 1fr;grid-auto-rows:minmax(0,auto);grid-gap:3px;color:#ff5252;box-sizing:border-box;background-color:#fff;padding:3px 13px;border-radius:4px;height:-webkit-max-content;height:-moz-max-content;height:max-content;border-top-left-radius:18px;border-top-right-radius:18px;border:1px solid rgba(204,212,216,.8);margin-top:-60px;margin-left:-24px;z-index:999}.comments[data-v-03de2f2e] .reply>.delete>.deletePrompt>label{grid-column:1/3;grid-row:2;font-weight:700;margin-left:-7px}.comments[data-v-03de2f2e] .reply>.delete>.deletePrompt>button{grid-row:1;font-size:11px;font-family:Roboto,sans-serif;background-color:#2a5ebe;color:#fff;font-size:12px;line-height:15px;border-radius:18px;border:none;cursor:pointer;outline:none;transition:all .1s linear;-moz-transition:linear .1s all;-webkit-transition:all .1s linear}.comments[data-v-03de2f2e] .reply>.delete>.deletePrompt>.yesPrompt{border:1px solid rgba(42,94,190,.9);background-color:rgba(42,94,190,.9);color:fff}.comments[data-v-03de2f2e] .reply>.delete>.deletePrompt>.yesPrompt:hover{border:1px solid #ff5252;background-color:#ff5252;color:#fff}.comments[data-v-03de2f2e] .reply>.delete>.deletePrompt>.noPrompt{border:1px solid rgba(42,94,190,.9);background-color:#fff;color:rgba(42,94,190,.9)}.comments[data-v-03de2f2e] .reply>.delete>.deletePrompt>.noPrompt:hover{border:1px solid rgba(42,94,190,.9);background-color:rgba(42,94,190,.9);color:#fff}.comments[data-v-03de2f2e] .popUp-enter-active{animation:pop-up-data-v-03de2f2e .2s ease-out forwards}.comments[data-v-03de2f2e] .popUp-leave-active{animation:pop-out-data-v-03de2f2e .2s ease-out forwards}@keyframes pop-up-data-v-03de2f2e{0%{margin-top:-45px;opacity:0}to{margin-top:-60px;opacity:1}}@keyframes pop-out-data-v-03de2f2e{0%{margin-top:-60px;opacity:1}to{opacity:0;margin-top:-45px}}", "" ]);
    }, function(module, exports, __webpack_require__) {
        "use strict";
 ...
 */
        ...
        "string" == typeof content && (content = [ [ module.i, content, "" ] ]), content.locals && (module.exports = content.locals);
        __webpack_require__(2)("1b096175", content, !0, {});
    }, function(module, exports, __webpack_require__) {
        exports = module.exports = __webpack_require__(1)(!1), exports.push([ module.i, '.signBox[data-v-05cdafea]{display:grid;grid-template-columns:1fr;grid-auto-rows:minmax(0,auto)}.firstSign[data-v-05cdafea]{display:grid;grid-template-columns:1fr .001fr 1fr;grid-auto-rows:minmax(0,auto);white-space:nowrap;grid-gap:5px}.firstSign>button[data-v-05cdafea],.signIn>button[data-v-05cdafea],.signUp>button[data-v-05cdafea]{width:100%;height:100%;font-family:Roboto,sans-serif;background-color:rgba(42,94,190,.9);color:#fff;box-sizing:border-box;padding:8px 10px;font-size:13px;line-height:16px;font-weight:700;border-radius:4px;border:none;cursor:pointer;outline:none;transition:all .1s linear;-moz-transition:linear .1s all;-webkit-transition:all .1s linear}.firstSign>.secondary[data-v-05cdafea],.signIn.secondary>button[data-v-05cdafea],.signUp.secondary>button[data-v-05cdafea]{border:2px solid rgba(42,94,190,.9);background-color:#fff;color:rgba(42,94,190,.9)}.firstSign>button[data-v-05cdafea]:hover,.signIn>button[data-v-05cdafea]:hover,.signUp>button[data-v-05cdafea]:hover{background-color:rgba(37,75,145,.9);color:#fff}.signBoxes>form[data-v-05cdafea]{display:grid;grid-template-columns:.001fr;grid-auto-columns:minmax(auto,-webkit-max-content);grid-auto-columns:minmax(auto,-moz-max-content);grid-auto-columns:minmax(auto,max-content);grid-auto-rows:minmax(0,auto);grid-gap:10px;grid-column-gap:5px;margin-bottom:10px;padding-top:10px}.inputBoxes[data-v-05cdafea]{grid-column:1;display:grid;grid-template-columns:.001fr;grid-auto-rows:minmax(0,auto)}.inputBoxes>input[data-v-05cdafea]{font-family:Roboto,sans-serif;box-sizing:border-box;background-color:#fff;border:none;border-bottom:2px solid #333;line-height:12px;outline:none;padding:10px 8px 2px;height:30px;text-overflow:ellipsis;margin-left:1px;margin-top:2px;border-top-left-radius:49px;border-top-right-radius:49px}.placeholder[data-v-05cdafea]{grid-column:1;align-self:center;justify-self:center;font-size:12px;margin-top:-21px;pointer-events:none;transition:all .2s ease;-moz-transition:.2s ease all;-webkit-transition:all .2s ease}.inputBoxes>input:focus~label[data-v-05cdafea]{margin-top:-60px}.inputBoxes>.upperHolder[data-v-05cdafea],.inputBoxes>input:focus~label[data-v-05cdafea]{color:#fff;box-sizing:border-box;font-size:12px;padding:2px 5px;border-radius:18px;background-color:#2a5ebe}.inputBoxes>.upperHolder[data-v-05cdafea]{margin-top:-60px!important}.inputBoxes>.placeholder.pass[data-v-05cdafea]{background-color:#4caf50!important}.inputBoxes>.placeholder.fail[data-v-05cdafea],.inputBoxes>.placeholder.pass[data-v-05cdafea]{margin-top:-60px!important;color:#fff;box-sizing:border-box;font-size:12px;padding:2px 5px;border-radius:18px}.inputBoxes>.placeholder.fail[data-v-05cdafea]{background-color:#ff5252!important}.bar[data-v-05cdafea]{position:relative}.bar[data-v-05cdafea]:after,.bar[data-v-05cdafea]:before{content:"";height:3px;width:0;bottom:0;position:absolute;background:#2a5ebe;transition:all .2s ease;-moz-transition:.2s ease all;-webkit-transition:all .2s ease}.bar[data-v-05cdafea]:before{left:50%}.bar[data-v-05cdafea]:after{right:50%}.inputBoxes>input:focus~.bar[data-v-05cdafea]:before,input:focus~.bar[data-v-05cdafea]:after{width:50%}.or[data-v-05cdafea]{grid-column:3;align-self:center;justify-self:center}.signIn[data-v-05cdafea]{grid-row:1/3}.signUp[data-v-05cdafea]{grid-row:1/5;align-self:stretch;justify-self:stretch}@media (hover:none){.signIn.secondary>button[data-v-05cdafea]:hover,.signUp.secondary>button[data-v-05cdafea]:hover{background-color:#fff;color:rgba(42,94,190,.9)}}input[data-v-05cdafea]:-webkit-autofill{animation-name:autofill-data-v-05cdafea;animation-fill-mode:both;-webkit-animation-name:autofill-data-v-05cdafea;-webkit-animation-fill-mode:both}@keyframes autofill-data-v-05cdafea{to{color:#1d2129;border-top-left-radius:49px;border-top-right-radius:49px;background-color:#fff}}@-webkit-keyframes autofill-data-v-05cdafea{to{color:#1d2129;border-top-left-radius:49px;border-top-right-radius:49px;background-color:#fff}}.shake[data-v-05cdafea]{animation-name:shakeKeyframe-data-v-05cdafea;animation-duration:.8s;animation-iteration-count:1}@keyframes shakeKeyframe-data-v-05cdafea{0%,to{transform:translateZ(0)}10%,30%,50%,70%,90%{transform:translate3d(-10px,0,0)}20%,40%,60%,80%{transform:translate3d(10px,0,0)}}', "" ]);
    }, function(module, __webpack_exports__, __webpack_require__) {
        "use strict";
        var render = function() {
